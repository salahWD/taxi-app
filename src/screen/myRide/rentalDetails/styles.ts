...
const styles = StyleSheet.create({
  ...
  requestedContainer: {
    marginHorizontal: windowWidth(3),
    justifyContent: "space-between", marginVertical: windowHeight(3),
  },
  ...
  calanderBigContainer: {
    ...
    marginTop: windowHeight(1), backgroundColor: appColors.graybackground,
    width: "100%"
  },
  calanderBig: { marginHorizontal: windowWidth(2) },
  riderContainer: {
  ...
  containerPrice: {
    borderStyle: "dashed",
    marginVertical: windowHeight(0.5), borderBottomWidth: windowHeight(0.1)
  },
  pickUpBorder: {
    borderStyle: "dashed",
    marginVertical: windowHeight(1), borderBottomWidth: windowHeight(0.1),
  },
  dropOffBorder: {
    borderStyle: "dashed",
    marginVertical: windowHeight(1), borderBottomWidth: windowHeight(0.1),
