    ...
    return (
        <View style={[styles.box, { backgroundColor: colors.card, borderColor: colors.border }]}>
            <View style={[styles.profile,{flexDirection:viewRtlStyle}]}>
                <DriverProfile borderRadius={25} backgroundColor={appColors.white} iconColor={appColors.primary} showCarTitle={true} showInfoIcon={false} userDetails={userDetails}  />
                <View style={commanStyle.containerBtn}>
                    ...
                    <TouchableOpacity style={commanStyle.iconButton} activeOpacity={0.5} onPress={gotoCall}>
