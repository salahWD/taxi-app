  ...
  return (
    <View style={[styles.dataView, { backgroundColor: colors.card, borderColor: colors.border }]}>
      ...
      >
        ...
        <Rect x={windowWidth(18)} y={windowHeight(2.6)} width={windowWidth(40)} height={windowHeight(2.5)} rx={0} />

        <Rect x={windowWidth(73)} y={windowHeight(2.6)} width={windowWidth(15)} height={windowHeight(2.5)} rx={0} />
      </ContentLoader>
    </View>
  );
}
