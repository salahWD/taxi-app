...
import {vehicleTypeDataGet, vehicleData, rentalVehicleTypesData} from '../action/vehicleTypeAction'
...
const vehicleTypeSlice = createSlice({
    ...
    extraReducers: builder => {
      ...
      builder.addCase(vehicleTypeDataGet.fulfilled, (state, action: PayloadAction<any[]>) => {
        state.loading = false;
      ...
      builder.addCase(rentalVehicleTypesData.fulfilled, (state, action: PayloadAction<any[]>) => {
        state.loading = false;
