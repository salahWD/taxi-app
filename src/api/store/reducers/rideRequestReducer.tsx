...
import { rideRequestDataGet,driverRequestDataGet, acceptRequestValue } from '../action/rideRequestAction'
...
const rideRequestTypeSlice = createSlice({
  ...
  extraReducers: builder => {
    ...
    builder.addCase(rideRequestDataGet.fulfilled, (state, action: PayloadAction<any[]>) => {
      state.loading = false;
